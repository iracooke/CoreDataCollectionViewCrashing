//
//  CollectionViewCoreData_AppDelegate.m
...
#import "CollectionViewCoreData_AppDelegate.h"
#import "ItemMO.h"
...
- (IBAction) clear:(id)sender {
	...
	NSArray *array = [itemArrayController arrangedObjects];
	
	NSMutableArray *objectsToRemove = [NSMutableArray new];
	
	BOOL isODD = NO;
	for ( ItemMO * item in array ){
		if ( isODD ){
...
/**
    ...
    store file.  This code uses a directory named "CollectionViewCoreData" for
...
- (NSString *)applicationSupportDirectory {
    ...
    return [basePath stringByAppendingPathComponent:@"CollectionViewCoreData"];
}
